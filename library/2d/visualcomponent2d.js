...
export class VisualComponent2D
{
    constructor( visualData )
    {
        ...
        this.drawMode = ((visualData.genType === defs.EGT_QUAD) || (visualData.genType === defs.EGT_SPRITE_SHEET)) ? gl.TRIANGLE_FAN : gl.TRIANGLES;
        this.indiceType = (visualData.genType === defs.EGT_FONT) ? gl.UNSIGNED_SHORT : gl.UNSIGNED_BYTE;
        this.frameIndex = 0;
        this.glyphUV = null;
        ...
        if( visualData.isActive() )
        {
            ...
            if( (this.texture !== null) || (visualData.genType === defs.EGT_FONT) )
            {
            ...
            if( visualData.genType === defs.EGT_FONT )
    ...
    render( objMatrix, projMatrix )
    {
        if( this.allowRender() )
        {
            ...
            if( this.visualData.genType === defs.EGT_QUAD )
            {
            ...
            else if( this.visualData.genType === defs.EGT_SPRITE_SHEET )
            {
                // Calculate the final matrix
                gFinalMatrix.initilizeMatrix();
            ...
            gl.drawElements(this.drawMode, this.iboCount, this.indiceType, 0);
        }
    }
    ...
    isFontSprite()
    {
        return (this.visualData.genType === defs.EGT_FONT);
    }
    ...
    setFrame( index )
    {
        ...
        if( this.visualData.genType === defs.EGT_SPRITE_SHEET )
        {
